...
Welcome to AutoWDS! This guide will help you create your first data scraping task in 5 minutes.
...
## Step 2: Launch AutoWDS

Click the AutoWDS icon in your browser toolbar to open the extension interface.
...
2. AutoWDS will automatically scrape data from the current page
